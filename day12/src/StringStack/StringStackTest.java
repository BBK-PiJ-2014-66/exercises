 ...
 * 
 */
public abstract class StringStackTest {

	protected StringStack testStack;

	/**
	 * initialize is called before each test is run,
	 * an abstract method that initializes testStack using 
	 * the particular implementation being tested 
	 */
	@Before
