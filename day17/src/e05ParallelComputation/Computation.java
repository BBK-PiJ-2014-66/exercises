...
public class Computation implements Runnable {
	 ...
	 *
	 * @param data
	 *            an array of doubles to perform the computation
	 */
	...
	public void run() {
		synchronized (this) {
			...
			// System.out.println("debug computation run start check r.nextDouble "
			// + r.nextDouble());
	...
	/**
	 * Returns the result of the computation if it is ready. If it is not, it
	 * blocks until it is.
	 *
